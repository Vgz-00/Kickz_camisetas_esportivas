        ...
        <nav className="border-orange-500 bg-orange-400 dark:bg-orange-800 dark:border-orange-700">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="./LogoTeste.png" className="h-12" alt="Logo Herbie" />
                        ...
                        <li>
                            {cliente.id ?
                                <>
                                    ...
                                    <Link to="/meusPedidos" className="text-white font-bold bg-gray-600 hover:bg-gray-700 focus:ring-2 focus:outline-none focus:ring-gray-400 rounded-lg text-sm w-full sm:w-auto px-3 py-2 text-center dark:bg-black dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                        Meus Pedidos
                                    </Link>&nbsp;&nbsp;
